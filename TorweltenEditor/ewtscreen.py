...
class EWTScreen(tk.Frame):
    ...
    def rollEWT(self, dice=1, column=0, transparent=False):
        ...
        Args:
            ...
            transparent(bool) if True the second return will be produced ... 
                Any out of bound entries will be sanitized to 1/0 rolls
        Returns: 
            float - accumulated roll result ...  
        ...
        while rolls > 0: 
            ...
            if transparent:
                result.append((roll, roll_result, reroll))
            else:
